...
func unmarshalStackFile(fileLocation string) GoLib.MicroServiceData {
	...
	fmt.Println("1")
	service := GoLib.MicroServiceData{}
...
func main() {
	...
	// }
	// hostname := "unl1_agent"
	var _ GoLib.MicroServiceData = unmarshalStackFile("/Users/jorrit/Documents/master-software-engineering/thesis/swarm_setup/stack/agents.yaml")
